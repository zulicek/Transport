    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register(string PrimaEmail, ExtendedRegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var user = new ApplicationUser { UserName = model.Email, Email = model.Email, IdKorisnik = korisnik.Id };
                ...
                if (result.Succeeded)
                {
                    ...
                    if (PrimaEmail == "on")
                    {
                        ...
                        using (var message = new MailMessage("carryontransport@gmail.com", user.Email)
                        {
